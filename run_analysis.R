...
testData <- as_tibble(read.table("./UCI HAR Dataset/test/X_test.txt"))
names(testData) <- featureNames
testActivity <- as_tibble(read.table("./UCI HAR Dataset/test/y_test.txt", col.names = "Activity"))
testSubject <- as_tibble(read.table("./UCI HAR Dataset/test/subject_test.txt", col.names = "SubjectID"))

trainData <- as_tibble(read.table("./UCI HAR Dataset/train/X_train.txt"))
names(trainData) <- featureNames
trainActivity <- as_tibble(read.table("./UCI HAR Dataset/train/y_train.txt", col.names = "Activity"))
trainSubject <- as_tibble(read.table("./UCI HAR Dataset/train/subject_train.txt", col.names = "SubjectID"))
